...
void Producer(void) {
        ...
        while (1) {
                ...
                while (bufAvail == 1) ThreadYield();

                // buffer = ASCII_START_INDEX + alphabet_index;
                // bufAvail = 1;

                // alphabet_index = (alphabet_index + 1) % ALPHABET_NUM;
